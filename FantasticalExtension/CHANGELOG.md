...
- Add to Fantastical, Add Task to Fantastical, Add to Fantastical Calendar, Search Fantastical, and
  Show Date in Fantastical text actions with inline fields (title, start, end, due, allday, cal,
  url, notes) after a configurable separator; link items become events with the address attached.
