...
EXTENSION_SCHEMES := ArenaExtension BrewExtension CleanShotExtension TunaGitHub NotesExtension NotionExtension ObsidianExtension RemindersExtension SafariExtension ThingsExtension
