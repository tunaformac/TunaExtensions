...
EXTENSION_SCHEMES := ArenaExtension BrewExtension CleanShotExtension TunaGitHub MyMindExtension NotesExtension NotionExtension ObsidianExtension RemindersExtension SafariExtension ThingsExtension
