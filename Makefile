...
EXTENSION_SCHEMES := ArenaExtension BrewExtension ChromeExtension CleanShotExtension FancyTextExtension FantasticalExtension TunaGitHub GiphyExtension Messages2FAExtension MusicExtension MyMindExtension NotesExtension NotionExtension ObsidianExtension PoofExtension RemindersExtension SafariExtension SpotifyExtension ThingsExtension
